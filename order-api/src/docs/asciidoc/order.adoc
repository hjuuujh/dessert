...
include::{snippets}/apporve-request-refund/curl-request.adoc[]
- header
include::{snippets}/apporve-request-refund/request-headers.adoc[]
- request
include::{snippets}/apporve-request-refund/http-request.adoc[]
include::{snippets}/apporve-request-refund/path-parameters.adoc[]
- response
include::{snippets}/apporve-request-refund/http-response.adoc[]
include::{snippets}/apporve-request-refund/response-fields.adoc[]
